...
const loadCity = async () => {
    ...
    let html = proviceTemplate({ proviceList });
...
const chooseCity = () => {
    ...
    $('.city-ul').children('li').on("tap", function(){
        ...
        let html = flag?citiesTemplate({ cityList }):citiesTemplate({ local:'本地优先' });
